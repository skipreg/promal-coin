...
/**
 * This class contains helper methods for collecting data from the database using .dilithium.db.Storage
 */
public class Helper {
    
    public static void putAccount(String address, AccountState state){
